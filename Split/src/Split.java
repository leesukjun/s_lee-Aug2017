...
public class Split {
	public static void main(String[] args) {//practice
		...
		sandwichSplit_V1("applespineapplesbreadlettustomatobaconmayohambreadcheese");
		sandwichSplit_V2("apples pineapples bread lettus tomato bacon mayo ham bread cheese");
	}
	public static void sandwichSplit_V1(String x) {
